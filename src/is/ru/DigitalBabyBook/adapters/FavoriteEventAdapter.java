...
public class FavoriteEventAdapter {
    ...
    public long insertFavorite(int babyID, long eventID, String description, String photo) {

        String[] cols = DbHelper.TableFavoriteEventCols; //  "babyID  1", "eventID  2", "description 3",  "photo 5"
